import pygame as pg
from settings import W, H, WINDOW_TITLE, FPS, PLAYER_MOVE_MODE, CMP_MOVE_MODE, END_GAME_MODE, BACKGROUND_IMAGE
from utils import draw_chain, draw_storage_pane, draw_player_pool, draw_cmp_pool, \
    is_available_moves, is_quit_event, quit_game, check_end_game, draw_game_result
from classes import Chain, Scope, Storage, PlayerPool, CmpPool, Ai, ResultPane
...
def main():
    ...
    while True:
        ...
        storage = Storage(player_pool, chain)
        ...
        while resume_game:
            ...
            img = pg.image.load(BACKGROUND_IMAGE)
            sc.blit(img, (0, 0))
